  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center px-4 py-8">
      <div className="w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-card border border-border/40 p-6 rounded-lg">
          {error && (
          ...
          {/* Station Address */}
          <div className="space-y-2">
            <label className="block text-sm font-medium">Station Address</label>
            <input
              type="text"
